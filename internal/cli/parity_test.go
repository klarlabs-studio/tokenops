...
var mcpOnly = map[string]string{
	...
	"tokenops_mode":              "GAP: no CLI way to read or set mode short of editing YAML",
	"tokenops_preferred_model":   "GAP: no CLI way to set the preferred model short of editing YAML",
	"tokenops_budget_set":        "GAP: no CLI way to set a budget short of editing YAML",
	"tokenops_session_budget":    "per-turn advice for the agent mid-session; no terminal equivalent makes sense",
	"tokenops_optimizations":     "GAP: no CLI listing of applied optimizations",
	...
	"tokenops_routing_proposals": "GAP: no CLI listing of routing proposals",
	"tokenops_routing_rule_set":  "GAP: no CLI way to set a routing rule short of editing YAML",
}
